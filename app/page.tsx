...
export default function MerchantApp() {
  ...
  useEffect(() => {
    ...
    // Safety timeout: if Firebase auth never resolves (e.g. blocked network in
    // sandboxed preview environments), fall through to the welcome screen so
    // the app is usable instead of hanging on the loading spinner forever.
